...
public class ChatDetailsActivity extends AppCompatActivity {
    ...
    public void navigate(Fragment activity, View transitionImage, Friend obj) {
        Intent intent = new Intent(ChatDetailsActivity.this, ChatDetailsActivity.class);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
              ...
              //  Toast.makeText(ChatDetailsActivity.this, "Refreshing Chat!", Toast.LENGTH_SHORT).show();
                ...
                for (DataSnapshot data : dataSnapshot.child(chatNode).getChildren()) {
                    if (data.child(Constants.NODE_RECEIVER_ID).getValue().toString().equals(FirebaseAuth.getInstance().getCurrentUser().getUid())) {
